...
public class Lec06Log {
    public static void main(String[] args) {
         ...
         * map(i->Util.faker().username().firstName()) : 이 연산자는 log()로부터 데이터를 받아 처리합니다. 여기서 처리란, 각 숫자를 Util.faker().username().firstName()를 사용하여 이름으로 변환하는 것을 의미합니다. 따라서 map()은 log()의 구독자입니다.
